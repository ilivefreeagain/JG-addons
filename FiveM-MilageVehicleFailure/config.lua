...
-- Debugging mode
Config.DebugMode = false  -- Disabled for production
...
Config.preventVehicleFlip = false        -- Disable flipping overturned cars
...
Config.MileageSystem = 'jg-vehiclemileage' -- default / jg-vehiclemileage / other
Config.KMDisplayPosition = 'bottom-center' -- Available positions for the NUI: 'bottom-right', 'bottom-left', 'top-right', 'top-left', 'bottom-center', 'top-center'

-- Config for the vehicle physics in harsh terrains
-- DISABLED FOR COMPATIBILITY WITH jg-mechanic/jg-handling - these scripts already handle vehicle physics
Config.EnableCarPhysics = false  -- DO NOT ENABLE - Conflicts with jg-mechanic handling system
Config.MaxSpeed = 80           -- In KM/hours
...
Config.BreakdownTypes = {
    ...
    {
        name = "PowerLoss",
        chance = 0.0,  -- DISABLED - Conflicts with jg-mechanic servicing system
        duration = 20000,
        action = function(vehicle)
            -- SetVehicleEnginePowerMultiplier(vehicle, -50.0)  -- DISABLED
    ...
    {
        name = "BrakeFailure",
        chance = 0.0,  -- DISABLED - Conflicts with jg-mechanic brake servicing
        duration = 20000,
        action = function(vehicle)
            -- SetVehicleBrake(vehicle, true)  -- DISABLED
            -- SetVehicleHandbrake(vehicle, true)  -- DISABLED
    ...
    },
    {
        ...
        chance = 0.0,  -- DISABLED - Conflicts with jg-mechanic suspension servicing and stancing
        duration = 30000,
        action = function(vehicle)
            -- SetVehicleSuspensionHeight(vehicle, 0.05)  -- DISABLED
    ...
    },
    {
        ...
        chance = 0.0,  -- DISABLED - Conflicts with jg-mechanic performance system
        duration = 25000,
        action = function(vehicle)
    ...
    {
        name = "ClutchFailure",
        chance = 0.0,  -- DISABLED - Conflicts with jg-mechanic clutch servicing
        duration = 20000,
        action = function(vehicle)
            -- SetVehicleClutch(vehicle, 0.2)  -- DISABLED
